...
class GPIO(pigpio.pi):
    def __init__(self,  sequence_1: int,
        ...
        if not self.connected:  # Check connection
            ...
            self.cb_seq_1 = self.init_pin(pin=sequence_1, pin_direction=pigpio.INPUT, pull_up_resistor=pigpio.PUD_DOWN, callback=callback_sequence_1, edge=pigpio.EITHER_EDGE)
